  ...
  <div class="flex flex-col gap-2 items-center">
    <GlareCard>
      ...
      >
        <div class="space-y-4">
          <div class="space-y-1">
            <h3 class="text-l font-semibold">The Hitchhiker's Guide</h3>
            <h2 class="text-2xl font-bold">Places I've Been</h2>
          </div>

          <div class="space-y-2 flex flex-col gap-4">
            <p class="text-sm text-white/80">Veni, vidi, vici!</p>
            <iframe
              :src="maps.placesBeen"
              class="w-full h-[250px] md:h-[300px] rounded"
            ></iframe>
          </div>
        </div>
      </div>

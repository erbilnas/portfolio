<template>
  <ScrollPanel class="workplaces" v-if="!isLoading">
    ...
    <Timeline v-else :value="workplaces" align="alternate">
      <template #marker="slotProps"> {{ slotProps.index % 2 === 0 ? '>' : '<' }} </template>

  ...
  >
    ...
    <div class="flex flex-row justify-center items-center gap-4">
      <Button
        ...
        class="rounded-full bg-slate-950/30 backdrop-blur-md hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-110 transition-all duration-300 border border-slate-800/50 hover:border-white/50"
      ...
      >
        ...
        >
          <div
            ...
            class="absolute inset-0 bg-gradient-to-r from-white/20 to-gray-300/20 animate-pulse-subtle blur-sm"
          />
        </Button>
      </div>

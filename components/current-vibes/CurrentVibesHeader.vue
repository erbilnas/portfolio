...
<template>
  <div class="text-center mb-8">
    <h1 class="text-4xl md:text-6xl font-bold animate-title-float">
      <span class="inline-block text-white"> Current Vibes </span>
    </h1>
    <p
    ...
    <div
      class="flex items-center justify-center gap-2 mt-4 text-white/60 text-xs md:text-sm animate-title-fade"
    >
